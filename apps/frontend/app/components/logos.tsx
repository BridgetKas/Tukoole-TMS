...
export default function LogosSection(){
    return (
        <div className="bg-linear-to-b from-purple-50 to-white">
            <p className="text-center px-2 pt-8 pb-9 text-gray-900">We are trusted by startups, government agencies and NGOs worldwide to deliver exceptional talent.</p>
